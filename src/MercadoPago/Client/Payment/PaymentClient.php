...
final class PaymentClient extends MercadoPagoClient
{
    ...
    const URL_WITH_ID = "/v1/payments/%s";

    const URL_SEARCH = "/v1/payments/search";
     ...
     * @throws \Exception if the request fails.
     */
    public function capture(int $id, $amount = null, RequestOptions $request_options = null): Payment
    {
